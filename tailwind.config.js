    ...
    extend: {
      keyframes: {
        ...
        "music-play-1": {
          ...
          "100%": {
            transform:
              "scale(4) translateY(-150%) translateX(-50%) rotate(90deg)",
            opacity: 0,
            filter: "blur(0.75px)",
          },
        },
        "music-play-2": {
          ...
          "100%": {
            transform:
              "scale(4) translateY(-100%) translateX(-200%) rotate(-90deg)",
            opacity: 0,
            filter: "blur(0.75px)",
          },
        },
        "music-play-3": {
          ...
          "100%": {
            transform:
              "scale(4) translateY(-150%) translateX(50%) rotate(45deg)",
            opacity: 0,
            filter: "blur(0.75px)",
          },
        },
        "music-play-4": {
          ...
          "100%": {
            transform:
              "scale(4) translateY(-100%) translateX(200%) rotate(-45deg)",
            opacity: 0,
            filter: "blur(0.75px)",
          },
        },
        "music-play-5": {
          ...
          "100%": {
            transform:
              "scale(4) translateY(-150%) translateX(-100%) rotate(-135deg)",
            opacity: 0,
            filter: "blur(0.75px)",
          },
        },
